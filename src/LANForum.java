...
public class LANForum extends AbstractHandler {
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response)
        ...
        responseText.append("<hr /><h3>Messages received so far:</h3>\n");
    ...
    public static void main(String[] args) throws Exception {
        ...
        server.setHandler(new LANForum());
        server.start();
        System.out.println("Server is live on " + getMyNetworkAdapter() + ":" + port);
        System.out.println("-----------------------------------------------------------------------");
        server.join();
    }
